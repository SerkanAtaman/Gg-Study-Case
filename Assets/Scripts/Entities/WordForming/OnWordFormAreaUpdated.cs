...
namespace GG.Entities.WordForming
{
    ...
    [CreateAssetMenu(menuName = "GG/Entities/WordFormArea/OnWordFormAreaUpdated")]
    public class OnWordFormAreaUpdated : BroadcastChannel
    {
        ...
        protected override void OnEnable()
        {
            ...
            base.OnEnable();
            content.Construct<WordFormingArea>(this);
        }
    }
}