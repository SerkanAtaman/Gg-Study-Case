...
namespace GG.Entities.WordForming
{
    ...
    [CreateAssetMenu(menuName = "GG/Entities/WordFormArea/OnWordSubmitted")]
    public class OnWordSubmitted : BroadcastChannel
    {
        ...
        protected override void OnEnable()
        {
            ...
            base.OnEnable();
            content.Construct<WordFormingArea, string>(this);
        }
    }
}